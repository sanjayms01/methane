...
# # LSTM Autoencoder Model Analysis - Russia   
#
# This notebook uses California Climate Zone pretrained models to predict anomalies on a specific region of Russia's Bashkortostan data.  The leak occured in 2021/05/24 (based on Blair's research: https://www.bloomberg.com/news/articles/2021-10-25/big-methane-plume-seen-from-space-on-day-of-russian-pipe-repair)    
#
...
def load_all_zone_data(describe=True):
    ...
    #Read in Data
    s3_file_path = 's3://methane-capstone/data/testsite2/combined-raw-data/combined-raw-bcj.parquet'
...
#     validation_date_threshold = '2021-06-01'   #Original threshold but our leak is on 6/4/2021
    validation_date_threshold = '2021-06-30'
...
def model_analysis_plots(region, train_mse_loss, ANOMALY_THRESHOLD, val_score_df,
    ...
    if save:
        feature_num = feature_number_map[feature]
        fig.savefig("./figures/russia/lstmae_pretrained_on_{}".format(pretrained_model))
...
zones = [1]  #all of this dataset in Russia is zone 1 for simplicity
...
local_path = '/root/methane/models/autoencoder/john/figures/russia/'
try:
...
flt_path = 'models/autoencoder/zone_model_artifacts/testsites/russia_feature_loss_tracker.pickle'
dft_path = 'models/autoencoder/zone_model_artifacts/testsites/russia_df_tracker.pickle'
mmt_path = 'models/autoencoder/zone_model_artifacts/testsites/russia_model_metrics_tracker.pickle'
...
# + jupyter={"source_hidden": true}
feature = 'methane_mixing_ratio_bias_corrected'
val_score_df, val_anomalies, ANOMALY_THRESHOLD = anomaly(train_mse_loss, val_mse_loss, train_zone, val_zone)
