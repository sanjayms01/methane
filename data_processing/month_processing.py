...
for year_list_ind, year in enumerate(['2018','2019','2020','2021'], 0):
    ...
    df_cur_year = pd.DataFrame(columns=columns)
...
gzip_write_path = 's3://methane-capstone/combined-raw-data/combined-raw-2.parquet.gzip'
parquet_write_path = 's3://methane-capstone/combined-raw-data/combined-raw-2.parquet'

df_all.to_parquet(parquet_write_path)

df_all.to_parquet(gzip_write_path, compression='gzip')

#Cross checking John's write
df_check = pd.read_parquet('s3://methane-capstone/combined-raw-data/combined-raw.parquet')
