...
#
# This notebook uses California Climate Zone pretrained models to predict anomalies on California (not need to retrain models).
#
# This notebook generates plots of the anomaly prediction and saves the plots locally on sagemaker.  

# +
# #For Synthetic Methane Anomaly
...
#         fig.suptitle("LSTM AE Pretrained Model ({}), Feature {}".format(pretrained_model, feature))  #title for entire subplot
    ...
    if save:
        feature_num = feature_number_map[feature]
        fig.savefig("./figures/california/lstmae_pretrained_on_{}".format(pretrained_model))
...
zones = [zone]  #all of this dataset in Russia is zone 1 for simplicity
...
local_path = '/root/methane/models/autoencoder/john/figures/california/'
try:
